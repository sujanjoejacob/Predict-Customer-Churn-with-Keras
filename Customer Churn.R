...
#Kernal desity plot 
d <- density(train_tbl_with_ids$TotalCharges)
...
# Predictors
##STEP 2: BAKING WITH YOUR RECIPE - We can apply the "recipe" to any data set with the bake() function, and it processes the data following our recipe steps.
...
##store the actual values (truth) as y_train_vec and y_test_vec
y_train_vec <- ifelse(pull(train_tbl, Churn) == "Yes", 1,0)
y_test_vec <- ifelse(pull(test_tbl, Churn) == "Yes", 1,0)

#Buidling our first ANN
...
# save the model
save_model_hdf5(model_keras, 'E:/Joe/Sample Projects/Customer Churn/customer_churn.hdf5')
